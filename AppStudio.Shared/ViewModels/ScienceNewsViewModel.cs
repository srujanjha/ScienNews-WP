...
{
    public class ScienceNewsViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "ScienceNewsDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new ScienceNewsDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("ScienceNewsDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("ScienceNewsList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("ScienceNewsDetail");
        }
    }
}
