...
{
    public class TOIScienceViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "TOIScienceDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new TOIScienceDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("TOIScienceDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("TOIScienceList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("TOIScienceDetail");
        }
    }
}
