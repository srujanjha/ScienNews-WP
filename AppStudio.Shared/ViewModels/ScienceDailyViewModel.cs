...
{
    public class ScienceDailyViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "ScienceDailyDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new ScienceDailyDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("ScienceDailyDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("ScienceDailyList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("ScienceDailyDetail");
        }
    }
}
